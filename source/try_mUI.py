...
class basicWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.Spacial_Monitor.setWidget(self.Picture.canvas)
        self.Spacial_Monitor.setWindowTitle('图像')

        self.mdi.addSubWindow(self.Spacial_Monitor)
        # self.mdi.addSubWindow(self.mPicture)
...
#         self.SpacialLabel.setAlignment(Qt.AlignCenter)
#         self.Spacial_Monitor = QMdiSubWindow()
#         self.Spacial_Monitor.setWidget(self.SpacialLabel)
#         self.Spacial_Monitor.setWindowTitle('图像')
#         self.mdi.addSubWindow(self.Spacial_Monitor)
#         self.Spacial_Monitor.show()
#         self.refreshPic()
...
#         self.Histogram_Monitor.setWidget(self.HistogramLabel)
